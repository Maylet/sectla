	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12">
				<div class="lft_hd">
					<a href="index.php"><img src="img/logo.png" height="80" width="80" alt=""/></a>
				</div>
			</div>			
			<div class="col-lg-9 col-md-9 col-sm-12">
				<div class="rgt_hd">					
					<div class="main_menu">
						...
						<div id="navbar">
							<ul>
								<li><a class="page-scroll" href="MENU_BUSCAR/index.html">Buscar</a></li> 
							...
							<ul>
								...
								<!--<li><a class="page-scroll" href="#abt_sec">Chat</a></li>
								
								<li><a class="page-scroll" href="#pr_sec">Mapas</a></li>-->
								<li><a class="page-scroll" href="COMO_REGISTRARTE/como_registrarte.html">Como registrarte?</a></li>
								<li><a class="page-scroll" href="ACERCA_DE/index.html">Acerca de...</a></li>
								<li><a class="page-scroll" href="login/index.php">Iniciar Sesión</a></li>
							</ul>
						</div>		
						</nav>			
					</div>					
					...
					<div class="item active">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1>Bienvenido a SecTla</h1>
							<p>Busca, Encuentra, Resuelve</p>
						  </div>						
						</div>
					</div>					
					<div class="item">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1>Busca</h1>
							<p>Todo la informacion de lugares que necesitas encontrar </p>
						  </div>						
						</div>
					</div>					
					<div class="item ">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1>Encuentra</h1>
							<p>de la manera mas facil que pueda ser</p>
						  </div>						
						</div>
					</div>			
				  </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="copy_right">
				<!-- 	<li>&copy;SecTla 2017</li>-->
					<li>SecTla 2017</li>
					<li>Instituto Tecnologico de Tlaxiaco</li>
				</ul>					
			</div>	
		</div>
	</div>
